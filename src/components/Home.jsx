...
const home = () => {
  return (
    <div
      name="Home"
      className="w-full h-screen bg-gradient-to-b from-black to-gray-800 text-gray-800 "
    >
        ...
        <div className="flex flex-col justify-center h-full pt-24">
          ...
          <div>
            <Link
              ...
              smooth
              duration={500}
              className="text-white w-fit px-6 py-3 my-2 rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer"
            >
              Portfolio
            </Link>
          </div>
