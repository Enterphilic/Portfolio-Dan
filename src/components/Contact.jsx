        ...
        <div name='Contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
            <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
                ...
                <div className='flex justify-center item-center'>
                    <form action="https://getform.io/f/79779908-df9b-4f52-872a-4de0f62524fd" method='post' className='flex flex-col w-full md-w1/2'> 
                        <input type="text" name='name' placeholder='Enter your name' className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none' />
                        <input type="text" name='Email' placeholder='Email address' className='my-4 p-2 bg-transparent border-2 rounded-md text-white focus:outline-none' />
