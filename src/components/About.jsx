    ...
    return (
        <div name="About" className='w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white'>
            <div className='max-w-screen-lg py-4 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                <br />
                <p className='text-xl'>
                    observing both detailed specifications and immediate word of mouth change request. Developed new features based on the functional specifications.
                    Researched and evaluated alternative technical solutions and recommend the most efficient and
